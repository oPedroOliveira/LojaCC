...
namespace LojaCCInfrastructure.Migrations
{
    ...
    [Migration("20241129232923_relacionaClienteUser")]
    partial class relacionaClienteUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LojaCCDomain.Models.User", b =>
                {
            ...
            modelBuilder.Entity("LojaCCDomain.Models.User", b =>
                {
                    b.HasOne("LojaCCDomain.Models.Cliente", null)
                        .WithOne("User")
                        .HasForeignKey("LojaCCDomain.Models.User", "ClienteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
